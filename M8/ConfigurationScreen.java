    ...
    public void configure() {
        ...
        confirmButton.addActionListener(e -> {
            ...
            if (!easyRadioButton.isSelected()
                    && !mediumRadioButton.isSelected() && !hardRadioButton.isSelected()) {
                JOptionPane.showMessageDialog(null, "Please select your difficulty!",
                        "Message", JOptionPane.ERROR_MESSAGE);
                throw new NullPointerException("Please select your difficulty!");
            }
            if ((diffLevel == 1 && sum > 20) || (diffLevel == 2 && sum > 16)
                ...
                displaySkill.setText("<html>Pilot Skill Points: " + pilot + "<br>Fighter Skill Poi"
                        + "nts:" + fighter + "<br>Merchant Skill Points: " + merchant + "<br>Engi"
                        + "neer Skill Points: " + engineer + "</html>");
                displayCredit.setText("credits: " + credits);
                gameController
                        .setPlayer(new Player(fighter, engineer, pilot, merchant, credits, name));
