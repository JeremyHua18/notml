...
public class FormRepair {
    ...
    public FormRepair(GameController gc) {
        ...
        //giving player eng skill == 1 regardless (to avoid div 0)
        repairPrice = (int) 3000 / (gc.getPlayer().getEngineerSkill() + 1);
        lblNote = new JLabel("Based on your engineer skill, repair will cost " + repairPrice
                + " credits per point.");
        ...
        btnConfirm.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent actionEvent) {
                ...
                if (currHealth == gc.getPlayer().getShip().getHealth()) {
                    JOptionPane.showMessageDialog(repairForm, "There's no need "
                                    + "to do repair!",
                            "Done", JOptionPane.INFORMATION_MESSAGE);
                } else if (amountNum / repairPrice > gc.getPlayer().getShip().getHealth()
                        - currHealth) {
                    JOptionPane.showMessageDialog(repairForm, "You don't have "
                                    + "enough health capacity!",
                            "Message", JOptionPane.ERROR_MESSAGE);
                } else if (amountNum < repairPrice) {
                    JOptionPane.showMessageDialog(repairForm, "Your offer is not "
                                    + "enough to do one repair!",
                            "Message", JOptionPane.ERROR_MESSAGE);
                    ...
                    JOptionPane.showMessageDialog(repairForm, "Your ship has been "
                                    + "repaired! You are charged "
                                    + bill + "credits",
                            "Done", JOptionPane.INFORMATION_MESSAGE);
        ...
        btnMax.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (currHealth == gc.getPlayer().getShip().getHealth()) {
                    ...
                    int repairGain = Math.min(gc.getPlayer().getShip().getHealth()
                            - currHealth, (int) currCredit / repairPrice);
                    ...
                    JOptionPane.showMessageDialog(repairForm, "We tried our best "
                                    + "to get your ship repaired!",
                            "Done", JOptionPane.INFORMATION_MESSAGE);
                    repairForm.setVisible(false);
                }
            }
