...
public class Player {
    ...
    public Player(int fighterSkill, int engineerSkill,
                  int pilotSkill, int merchantSkill, int credit, String name) {
        ...
        this.name = name;
        this.karmaPercent = 1.00;
    }

    public void gainKarma() {
        this.karmaPercent += 0.05;
    }
    ...
    public double getKarmaPercent() {
        return karmaPercent;
    }

    public void setKarmaPercent(double karmaPercent) {
        this.karmaPercent = karmaPercent;
    }
}
