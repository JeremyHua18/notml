public class GameController {
    ...
    private boolean npcOpen;

    public boolean isNpcOpen() {
        return npcOpen;
    }

    public void setNpcOpen(boolean npcOpen) {
        this.npcOpen = npcOpen;
    }
    ...
    public void showEndGameUI(boolean winFlag, GameController gameController) {
        endGameUI = new EndGameUI(winFlag, gameController);
