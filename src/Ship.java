...
public class Ship {
    ...
    protected enum ShipType {
        WOOD("Wood", 3, 2000, 10),
        PLASTIC("Plastic", 3, 2000, 15),
        FIBERGLASS("Fiberglass", 3, 2000, 20),
        STEEL("Steel", 3, 2000, 22),
        CARBONFIBER("Carbonfiber", 3, 2000, 24),
        DIAMOND("Diamond", 3, 2000, 25);
        private String name;
        private int cargo;
        private int fuel;
        private int health;
    ...
    public String toString() {
        return "Ship {"
                + "Name ='" + shipName + '\''
                + ", Space Remaining=" + cargoSpaceRemaining
                + ", Fuel Remaining=" + fuelCapacityRemaining
    ...
    public boolean containGoldenSnitch() {
        return cargoList.get(10) == 1;
    }
