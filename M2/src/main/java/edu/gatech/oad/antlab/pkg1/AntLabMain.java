 ...
 public class AntLabMain {
    ...
    public void printOutMessage() {
        ...
        String toPrint = 
		  ...
		  Person1 p1 = new Person1("Nicholas Hutchison");
		  toPrint += p1.toString("nhutchison3");
		  //Person2 replace P2 with your name
		  //and gburdell with your gt id
		  Person2 p2 = new Person2("Tianyi Zuo");
		  toPrint += p2.toString("tzuo9");
		  //Person3 replace P3 with your name
		  //and gburdell3 with your gt id
		  Person3 p3 = new Person3("Farouk Marhaba");
		  toPrint += p3.toString("fmarhaba3");
		  //Person4 replace P4 with your name
          //and gburdell4 with your gt id
          Person4 p4 = new Person4("Jeremy Hua");
          toPrint += p4.toString("shua33");
